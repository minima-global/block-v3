...
function Index() {
  ...
  const isOnChain = data ? !!data?.onChain : false;
  const confirmations = data?.onChain?.confirmations ? Number(data.onChain.confirmations) : false;
        ...
        {isOnChain && (
          <div className="flex flex-col md:flex-row md:items-center gap-2">
            {(confirmations && confirmations < 3) && (
              <div className="flex w-[200px] md:w-fit items-center gap-3 border px-3 py-1.5 text-xs lg:text-sm dark:border-yellow-900 dark:bg-yellow-900 dark:bg-opacity-20">
                <span>Status:</span>
                <svg
                  width="32"
                  height="32"
            ...
            {(confirmations && confirmations > 3) && (
              <div className="flex w-[200px] md:w-fit items-center gap-3 border px-3 py-1.5 text-xs lg:text-sm dark:border-green-900 dark:bg-green-900 dark:bg-opacity-20">
                <span>Status:</span>
                <svg
                  width="32"
                  height="33"
            ...
            <div className="flex w-[200px] md:w-fit items-center gap-3 border px-3 py-1.5 text-xs lg:text-sm dark:border-green-900 dark:bg-green-900 dark:bg-opacity-20">
              <span className="text-black dark:text-white">Confirmations: {confirmations}</span>
            </div>
            {data?.onChain && (
              <Link to={`/blocks/$id`} params={{ id: data.onChain.blockid }}>
                <div className="flex w-[200px] md:w-fit items-center gap-3 border py-1.5 pl-3 pr-2.5 text-sm dark:border-mediumDarkContrast dark:bg-mediumDarkContrast dark:bg-opacity-50">
                  <svg
                    width="18"
                    height="20"
                    viewBox="0 0 18 20"
